...
#### Crazy high Kd for zircon
KdCrazyZrnT<-function(TK){
  kdTh<- exp( -5.27 + 8081/TK)
  kdU <- exp( 0.636 + 4244/TK)
...
KdClaiborneZrnTi<-function(Tippm){
...
KdTrailZrnMulti<-function(fO2,TK,DLa,DPr){
